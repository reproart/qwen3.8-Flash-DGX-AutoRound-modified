...
Default behaviour unchanged. From upstream blazux/qwen3.8-Flash-DGX (8347e7c), via
Saren-Arterius/qwen3.8-Flash-DGX-AutoRound (Dockerfile patch 9).

usage: patch_qsa_exact_topk.py <path to vllm/models/qwen3_8_flash_next/nvidia/ops/qsa.py>"""
import sys
F = sys.argv[1]
src = open(F).read()
